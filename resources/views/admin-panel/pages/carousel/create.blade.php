        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">Tambah Carousel</div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-6 col-12 col-sm-6">
                    ...
                    @endif
                    <form action="{{ route('admin-panel.carousel.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <img src="https://via.placeholder.com/1920x780.jpg?text=1920x823" style="max-height:400px;" id="banner_image_preview" alt="Gambar Banner">
                                </div>
                                <div class="form-group">
                                    <label for="">Gambar Banner <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="banner_html" id="banner_html" class="codeeditor">{{ old('banner_html') }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_title" id="link_title" class="form-control" placeholder="Masukkan Judul Link" value="{{ old('link_title') }}">
                                </div>
                            </div>
                        </div>
