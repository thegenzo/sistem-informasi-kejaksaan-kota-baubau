    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Manajemen Carousel</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item active">Manajemen Carousel</div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <a href="{{ route('admin-panel.carousel.create') }}" class="btn btn-icon icon-left btn-primary mb-4"><i
                            class="fas fa-plus"></i>Tambah Carousel</a>
                </div>
            </div>
            <div class="row">
                                    ...
                                    @forelse ($carousel as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin-panel.carousel.edit', $data->id) }} " class="btn btn-warning"
                                                    data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <form action="{{ route('admin-panel.carousel.destroy', $data->id) }}" method="POST" class="d-inline swal-confirm">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" style="font-weight: bold; font-size: 18px;"
                                                class="text-center">Data Carousel Kosong</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
