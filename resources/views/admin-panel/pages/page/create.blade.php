        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">Tambah Halaman</div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-6 col-12 col-sm-6">
                    ...
                    @endif
                    <form action="{{ route('admin-panel.page.store') }}"  onsubmit="return editorJsSave()" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
